...
namespace HotelProject.WebUI.Controllers
{
    public class AdminContactController : Controller
    {
        ...
        public async Task<IActionResult> Inbox()
        {
            ...
            var responseMessage = await client.GetAsync("http://localhost:44322/api/Contact");

            var client2 = _httpClientFactory.CreateClient();
            var responseMessage2 = await client2.GetAsync("http://localhost:44322/api/Contact/GetContactCount");

            var client3 = _httpClientFactory.CreateClient();
            var responseMessage3 = await client3.GetAsync("http://localhost:44322/api/SendMessage/GetSendMessageCount");
        ...
        public async Task<IActionResult> Sendbox()
        {
            ...
            {
                var jsonData = await responseMessage.Content.ReadAsStringAsync();
                var values = JsonConvert.DeserializeObject<List<ResultSendeboxDto>>(jsonData);
                return View(values);
            }
            return View();
        }
